...
import { Compass, LogIn, Lock, User, AlertCircle, RefreshCw } from 'lucide-react';
        ...
        <div className="min-h-[70vh] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50/50">
            <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
                ...
                <p className="mt-1.5 text-sm text-gray-500">
                    ...
                    <Link to="/signup" className="font-semibold text-rose-500 hover:text-rose-600 transition-colors">
                        Sign up for free
                    </Link>
                </p>
            </div>
